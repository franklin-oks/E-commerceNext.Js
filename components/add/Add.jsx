...
//       id: product.id,
//       name: product.name,
//       price: Number(product.price), // Ensure numeric price
//       image: product.image1, // Use main image
...
//             className="text-2xl px-4 py-2 bg-gray-200 rounded-full hover:bg-gray-300"
//           >
//             -
//           </button>
...
//           className="w-32 h-max ml-3 text-xs cursor-pointer rounded-3xl ring-1 ring-pink-500 text-pink-500 py-2 px-4 hover:bg-pink-500 hover:text-white"
//         >
//           Add to Cart
//         </button>
//       </div>
