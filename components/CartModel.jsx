...
/**
 * CartModel — shopping cart sidebar modal
 *
 * Fixes:
 * - derives cartItems and cartTotal from cart context
 * - adds email input (customerEmail) so Paystack always receives an email
 * - generates checkoutId on mount to use as reference/metadata
 */
