...
import { fetchMergedProducts } from "@/libMerge/mergeProducts";

const ProductsPage = async () => {
  const products = await fetchMergedProducts(); // merged API + fallback
      ...
      <div className="hidden bg-pink-50 md:flex px-4 justify-between h-64">
        <div className="w-2/3 flex flex-col items-center justify-center gap-8">
          <h1 className="text-4xl leading-[48px] font-semibold text-gray-700">
            Grab up to 50% Discount on <br /> Selected Products
          </h1>
